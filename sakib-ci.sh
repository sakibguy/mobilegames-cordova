...
git commit -m "obstacle 4: MAGICFOREST"
...
git remote set-url origin https://github.com/sakib-rahman-bangladesh/cordova2d-games.git
...
git push --all -f https://github.com/sakib-rahman-bangladesh/cordova2d-games.git